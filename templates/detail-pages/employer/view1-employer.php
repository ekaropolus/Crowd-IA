                        ...
                        <div class="jobsearch-employer-wrap-section">
                            ...
                            if ($total_team > 0 && $reults_per_page > 0 && $total_team > $reults_per_page) {
                                ...
                                <div class="jobsearch-load-more">
                                    <a class="load-more-team" href="javascript:void(0);" data-id="<?php echo ($employer_id) ?>" data-pref="jobsearch" data-rand="<?php echo ($rand_num_ul) ?>" data-pages="<?php echo ($total_pages) ?>" data-page="1"><?php esc_html_e('Load More', 'wp-jobsearch') ?></a>
                                </div>
                                <?php
                            }
                            ?>
