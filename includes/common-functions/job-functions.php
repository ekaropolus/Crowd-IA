...
if (!function_exists('jobsearch_job_send_to_email_mail')) {
    ...
    function jobsearch_job_send_to_email_mail() {
        ...
        $send_msg = sprintf(__('Job Link: <a href="%s">%s</a>', 'wp-jobsearch'), get_permalink($email_job), get_the_title($email_job)) . ' - (' . get_permalink($email_job) . ')' . ' - ' . $email_msg;
