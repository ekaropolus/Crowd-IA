        ...
        if ($all_location_allow == 'on') {
            ...
            <div class="jobsearch-employer-box-section">
                ...
                <ul class="jobsearch-row jobsearch-employer-profile-form">
                    ...
                    <li class="jobsearch-column-4 dash-maploc-latfield" <?php echo ($allow_location_map != 'yes' ? 'style="display: none;"' : '') ?>>
                        <label><?php esc_html_e('Latitude', 'wp-jobsearch') ?></label>
                        <?php
                        $field_params = array(
                            'id' => 'jobsearch_location_lat_' . $rand_num,
                    ...
                    <li class="jobsearch-column-4 dash-maploc-lngfield" <?php echo ($allow_location_map != 'yes' ? 'style="display: none;"' : '') ?>>
                        <label><?php esc_html_e('Longitude', 'wp-jobsearch') ?></label>
                        <?php
                        $field_params = array(
                            'id' => 'jobsearch_location_lng_' . $rand_num,
                    ...
                    <li class="jobsearch-column-4 dash-maploc-zoomfield" <?php echo ($allow_location_map != 'yes' ? 'style="display: none;"' : '') ?>>
