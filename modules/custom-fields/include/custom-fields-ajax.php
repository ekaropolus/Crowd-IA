...
// hook things up
    ...
    public function jobsearch_custom_field_ready_array($array_counter = 0, $field_type = '', $custom_field_element_array = array()) {
        $possible_element_fields = apply_filters('jobsearch_custom_fields_ready_array', array('non_reg_user', 'name', 'required', 'label', 'placeholder', 'classes', 'enable-search', 'icon', 'icon-group', 'multi', 'post-multi', 'collapse-search', 'date-format', 'min', 'laps', 'interval', 'field-style', 'options'));
