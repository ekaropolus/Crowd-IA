...
jQuery(document).on('click', '.jobsearch-apply-woutreg-btn', function (e) {
    ...
    var phone_number = msg_form.find('input[name="user_phone"]');
     // var curr_salary = msg_form.find('input[name="user_salary"]'); CHS - Registro rapido
	 
	 // INI CHS Registro rápido validando phone <> 0
	...
	// FIN CHS Registro rápido validando phone <> 0

  

    /* INI CHS - Registro rapido
